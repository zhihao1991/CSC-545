...
void setup()
{
  //program setup 
  size(1280,800,P3D);
  title = loadImage("background.png");
  frameRate(60);
  started = false;
  selection = false;
...
// sound and minim setup parameters
  ...
  mp3 = minim.loadFile("Demons.mp3",4096);// load your mp3 file here make sure you use processing's built in add file feature and type the name of the loaded mp3 inside the quotation marks
